...
- Use api calling for the ones with apis - Google calender, 
- Use computer control for the ones with no api.

## User flow:

- Login in to the ios/android app 
- login 
- show user all the apps that they can control/(optional) dynamic websites that are more experimental
- Ask user to select and login into some apps like exampe: amazon/google 
- Show user the main screen that has a text box to write what they want to do.
- Ask user to press enter to finish the request.
...
## Shopping Assistant
- Order something on amazon (or other sites)
- Find the best deal on slickdeals
